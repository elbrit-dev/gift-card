...
export default function UserDropdown() {
  ...
  // MSAL sign out: this removes SSO session, context, storage, and redirects
  async function handleSignOut() {
    setUser(null);           // Clear React context
    localStorage.clear();    // Clear any local storage you use
    sessionStorage.clear();  // Clear session storage

    // Remove MSAL session and redirect to /signin
