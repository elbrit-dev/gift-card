...
const ToBeActivatedCardsTable: React.FC<ToBeActivatedCardsTableProps> = ({
  ...
  const downloadSelectedAsCSV = () => {
    ...
    const csv = [
      ["Gift Card No", "Sales Team", "HQ", "Status", "Dr Name", "Dr Phone", "Emp Name", "Emp Designation", "Emp Phone", "Expiry"],
      ...selectedData.map(c => [
        ...
        <thead>
          <tr className="bg-gray-50 dark:bg-gray-800">
            ...
            {[
              ...
              "Dr Name", "Dr Phone", "Emp Name", "Emp Designation", "Emp Phone", "Expiry"
            ].map((title, idx) => (
              <th key={idx} className="px-3 py-2 font-medium text-left text-gray-700 dark:text-white border border-gray-200 dark:border-gray-700">
                {title}
              </th>
            ))}
          </tr>
